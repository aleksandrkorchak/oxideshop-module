...
<tr>
    <td class="edittext">
        [{oxmultilang ident="ARTICLE_MAIN_PREPAYMENT_AMOUNT"}] ([{$oActCur->sign}])
    </td>
    <td class="edittext">
        <input type="text" class="editinput" size="8" maxlength="[{$edit->oxarticles__oxprepayment->fldmax_length}]" name="editval[oxarticles__oxprepayment]" value="[{$edit->oxarticles__oxprepayment->value}]" [{$readonly}]>
        [{oxinputhelp ident="HELP_ARTICLE_MAIN_PREPAYMENT_AMOUNT"}]
    </td>
</tr>

<tr>
    <td class="edittext">
        [{oxmultilang ident="ARTICLE_MAIN_INSTALLMENT_MONTHS"}]
    </td>
    <td class="edittext">
        <input type="text" class="editinput" size="8" maxlength="[{$edit->oxarticles__oxmonthsremain->fldmax_length}]" name="editval[oxarticles__oxmonthsremain]" value="[{$edit->oxarticles__oxmonthsremain->value}]" [{$readonly}]>
        [{oxinputhelp ident="HELP_ARTICLE_MAIN_INSTALLMENT_MONTHS"}]
    </td>
</tr>
